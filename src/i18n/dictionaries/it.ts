...
export const it: Dictionary = {
  ...
  home: {
    ...
    ctoRows: [
      {
        aspect: 'Cosa ricevi',
        other: 'Decisioni, specifiche, una roadmap',
        khufu: 'Un prodotto online, in produzione',
      },
      {
        aspect: 'Chi costruisce',
        other: 'Nessuno — il team è ancora tutto da assumere',
        khufu: 'Analisi, design, sviluppo, mobile, infra: tutto coperto',
      },
      {
        aspect: 'Tempo fino alla V1',
        other: 'Mesi, una volta assunto il team',
        khufu: `${site.v1Days} giorni`,
      },
      {
        aspect: 'Cosa paghi',
        other: 'Un canone mensile, più gli stipendi del team',
        khufu: `Un prezzo fisso concordato in anticipo: [[${site.v1PriceEUR}]]`,
      },
      {
        aspect: 'Alla fine',
        other: 'Hai un piano',
        khufu: 'Hai il prodotto, il repository e gli accessi',
      },
    ],
    ctoNote:
      'Nulla contro i CTO frazionali: se hai già un team da guidare, è la scelta giusta. Se non ce l’hai, quello che ti serve è un team.',

    teamTitle: 'Tutti i ruoli di un team tecnico, in un solo contratto',
    teamSubtitle:
      'Non ne assumi nessuno. Ottieni ciò che producono — un unico interlocutore, dall’analisi alla messa in produzione.',
    teamRoles: [
      'Analisi di prodotto',
      'Design UI / UX',
      'Sviluppo front-end',
    ...
    how: [
      ...
      {
        title: 'Un founder-operator, non una catena di subappalti',
        body: 'Il team è un founder-operator potenziato dall’IA — un unico interlocutore, nessun coordinamento a carico tuo. Khufu ha lanciato i suoi prodotti (OneStore.link, Clokizi, HerbaCRM…) esattamente con questo metodo.',
      },
    ],
    ...
    offersTitle: 'Una sola offerta: lo Sprint V1',
    offersSubtitle: `La tua V1 progettata, sviluppata e messa in produzione in ${site.v1Days} giorni, a prezzo fisso. È ciò che Khufu vende.`,
    followUpsTitle: 'Dopo lo sprint',
    followUpsBody: 'Una volta online la tua V1, due modi per continuare — a tua scelta, e mai prima.',
  ...
  offers: {
    ...
    items: [
      {
        ...
        features: [
          ...
          'Infrastruttura, hosting e messa in produzione',
          'Sito showcase del prodotto, ottimizzato SEO e GEO',
          '2 settimane di correzioni dopo la consegna',
    ...
    remoteNoteShort: 'Lavoro in sede possibile, a determinate condizioni.',
    remoteNote:
      'Lavoro on-site possibile: 1 settimana minimo, +50 % sulla tariffa, con spese (trasferta, alloggio) a carico del cliente.',
    firmPriceNote: 'Prezzo fisso, fatturato in euro o in dollari, a tua scelta.',
  ...
  maintenance: {
    ...
    devNote:
      'Impegno 6 mesi. Configurazione degli strumenti di tracking obbligatoria all’avvio: 1 giorno ([[1200]]). Ore di sviluppo aggiuntive fatturate a [[200]]/h.',
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: `Khufu è un’agenzia di prodotto AI-native specializzata nella velocità: il tuo SaaS o la tua app mobile in produzione in ${site.v1Days} giorni, per un prezzo fisso di [[${site.v1PriceEUR}]]. È un posizionamento raro: ambito ristretto, prezzo in vista, codice consegnato.`,
      },
      {
      ...
      },
      {
        ...
        a: `Puoi continuare con l’offerta Full Maintenance (infra gestita, supporto con SLA e giornate di sviluppo incluse ogni mese) o con il supporto remoto a [[${site.dailyRateEUR}]]/giorno ([[200]]/h). Il codice sorgente ti appartiene in ogni caso.`,
      },
      {
        q: 'Qual è la tariffa di Khufu come rinforzo?',
        a: `Il rinforzo è 100 % remoto, fatturato a [[200]]/h con granularità oraria (cioè [[${site.dailyRateEUR}]]/giorno), senza vincoli di durata. È possibile un lavoro on-site: 1 settimana minimo, +50 % sulla tariffa e spese a carico del cliente.`,
      },
      {
