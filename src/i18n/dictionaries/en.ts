...
export const en: Dictionary = {
  ...
  home: {
    ...
    heroSubtitle: `We design, build and ship your SaaS or mobile app in ${site.v1Days} days. Fixed price: [[${site.v1PriceEUR}]].`,
    ...
    offersTitle: 'One offer: the V1 Sprint',
    offersSubtitle: `Your V1 designed, built and shipped to production in ${site.v1Days} days, at a fixed price. That is what Khufu sells.`,
    followUpsTitle: 'After the sprint',
    followUpsBody: 'Once your V1 is live, two ways to keep going — your call, and never before.',
    ...
    items: [
      {
        ...
        features: [
          ...
          'Infrastructure, hosting and production deploy',
          'Showcase site for the product, SEO- and GEO-optimised',
    ...
    tiers: [
      {
        ...
        featured: false,
        features: ['Managed infra + monitoring', 'Support within 48 hours', '8 h of dev / month included', 'Monthly report'],
      },
      {
        id: 'growth',
        name: 'Growth',
  ...
  work: {
    metaTitle: 'Work',
    metaDescription:
      'Web and mobile products designed and shipped by Khufu: OneStore.link, Clokizi, HerbaCRM, Labyrinth.',
