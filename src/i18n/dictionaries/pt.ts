...
export const pt: Dictionary = {
  ...
  home: {
    ...
    offersTitle: 'Uma única oferta: o Sprint V1',
    offersSubtitle: `A tua V1 concebida, desenvolvida e colocada em produção em ${site.v1Days} dias, a preço fixo. É o que a Khufu vende.`,
    followUpsTitle: 'Depois do sprint',
    followUpsBody: 'Assim que a tua V1 estiver online, duas formas de continuar — à tua escolha, e nunca antes.',
  ...
  offers: {
    ...
    items: [
      {
        ...
        features: [
          ...
          'Infraestrutura, alojamento e colocação em produção',
          'Site showcase do produto, otimizado para SEO e GEO',
          '2 semanas de correções após a entrega',
    ...
    remoteNoteShort: 'Trabalho presencial possível, com condições.',
    remoteNote:
    ...
    guarantees: [
      ...
      'Uma data de entrega, cumprida: começamos numa segunda-feira e sete dias depois está em produção.',
  ...
  method: {
    ...
    kicker: 'O método',
    title: 'Uma semana reservada, um produto lançável.',
    subtitle: 'De segunda-feira às 06:00 UTC a domingo, um só cliente por semana. Sabe exatamente o que acontece, todos os dias.',
    ...
    days: [
      ...
      { day: 'Dia 6–7', title: 'Correções e lançamento', body: 'Aplicamos o seu feedback de sexta-feira, finalizamos, e a sua V1 está em produção no final de domingo. Online, ou não entregue: é o único critério de entrega.' },
    ],
  ...
  work: {
    metaTitle: 'Projetos',
    metaDescription:
      'Produtos web e móveis concebidos e lançados pela Khufu: OneStore.link, Clokizi, HerbaCRM, Labyrinth.',
  ...
  faq: {
    ...
    items: [
      ...
      {
        q: 'Quando começa um sprint?',
        a: 'Um sprint começa sempre na segunda-feira às 06:00 UTC e termina no domingo: sete dias, fim de semana incluído. A Khufu conduz um sprint de cada vez — uma semana, um cliente. O enquadramento, o âmbito escrito e os acessos resolvem-se antes da segunda-feira, no dia 0, para não consumirem a semana. A sexta-feira (dia 5) é o seu dia de testes: você testa enquanto tratamos da entrada em produção e da infraestrutura. Sábado e domingo servem para as correções saídas dos seus testes, e a V1 está em produção no final de domingo.',
      },
    ],
  },
  ...
  privacyPage: {
    ...
    sections: [
      ...
      {
        heading: 'Publicidade no LinkedIn',
        body: 'Se o aceitar (e, fora da UE/EEE/Reino Unido, salvo se o recusar), o site carrega o LinkedIn Insight Tag. Permite ao LinkedIn medir o desempenho dos nossos anúncios e voltar a mostrar-lhe os nossos conteúdos no LinkedIn. O LinkedIn atua então como corresponsável pelo tratamento; consulte a sua política de privacidade.',
      },
      {
