...
const projectsData: ProjectInput[] = [
  ...
  },
  {
    ...
    tagline: {
      ...
      de: 'Das mobile TCG, das deine Karten in echte Erlebnisse im echten Leben verwandelt.',
      it: 'Il TCG mobile che trasforma le tue carte in vere esperienze IRL.',
      pt: 'O TCG mobile que transforma as tuas cartas em experiências reais IRL.',
      nl: 'De mobiele TCG die je kaarten omzet in echte IRL-ervaringen.',
      ar: 'لعبة TCG للجوال التي تحوّل بطاقاتك إلى تجارب حقيقية على أرض الواقع.',
      pl: 'Mobilna gra TCG, która zamienia twoje karty w prawdziwe doświadczenia IRL.',
      tr: 'Kartlarını gerçek hayattaki (IRL) deneyimlere dönüştüren mobil TCG.',
    },
    description: {
      ...
      de: 'Peach Farmer ist ein Sammelkartenspiel (TCG) fürs Handy: Die schönsten Karten verwandeln sich in echte Erlebnisse im echten Leben — Wochenenden auf Ibiza, Festivals, private Partys. Von Khufu konzipiert und entwickelt, vom Gameplay bis zum Echtzeit-Backend.',
      it: 'Peach Farmer è un gioco di carte collezionabili (TCG) su mobile: le carte più belle si trasformano in vere esperienze IRL — weekend a Ibiza, festival, feste private. Progettato e sviluppato da Khufu, dal gameplay al backend in tempo reale.',
      pt: 'O Peach Farmer é um jogo de cartas colecionáveis (TCG) para mobile: as melhores cartas transformam-se em experiências reais IRL — fins de semana em Ibiza, festivais, festas privadas. Concebido e desenvolvido pela Khufu, do jogo ao backend em tempo real.',
      nl: 'Peach Farmer is een verzamelkaartspel (TCG) voor mobiel: de mooiste kaarten veranderen in echte IRL-ervaringen — weekends op Ibiza, festivals, privéfeesten. Ontworpen en gebouwd door Khufu, van gameplay tot realtime backend.',
      ar: 'Peach Farmer هي لعبة بطاقات قابلة للتجميع (TCG) على الجوال: تتحوّل أجمل البطاقات إلى تجارب حقيقية على أرض الواقع — عطلات نهاية الأسبوع في Ibiza ومهرجانات وحفلات خاصة. صُمّمت وطُوّرت بواسطة Khufu، من اللعب إلى الواجهة الخلفية في الوقت الفعلي.',
      pl: 'Peach Farmer to mobilna kolekcjonerska gra karciana (TCG): najlepsze karty zamieniają się w prawdziwe doświadczenia IRL — weekendy na Ibizie, festiwale, prywatne imprezy. Zaprojektowana i stworzona przez Khufu, od rozgrywki po backend działający w czasie rzeczywistym.',
      tr: 'Peach Farmer, mobil bir koleksiyon kart oyunudur (TCG): en güzel kartlar gerçek hayattaki (IRL) deneyimlere dönüşür — Ibiza hafta sonları, festivaller, özel partiler. Oyundan gerçek zamanlı arka uca kadar Khufu tarafından tasarlandı ve geliştirildi.',
    },
    challenge: {
      fr: 'Créer un jeu de cartes à collectionner mobile qui ne s’arrête pas à l’écran : les plus belles cartes doivent débloquer de vraies expériences (weekends, festivals, soirées). Le défi — lier un gameplay addictif à des récompenses réelles, de façon fluide et fiable.',
      en: "Building a mobile trading card game that doesn't stop at the screen: the best cards must unlock real experiences (weekends, festivals, parties). The challenge — tying addictive gameplay to real-world rewards, smoothly and reliably.",
      es: 'Crear un juego de cartas coleccionables para móvil que no se quede en la pantalla: las mejores cartas deben desbloquear experiencias reales (fines de semana, festivales, fiestas). El reto — unir una jugabilidad adictiva a recompensas reales, de forma fluida y fiable.',
      de: 'Ein mobiles Sammelkartenspiel schaffen, das nicht am Bildschirm endet: Die schönsten Karten sollen echte Erlebnisse freischalten (Wochenenden, Festivals, Partys). Die Herausforderung — süchtig machendes Gameplay mit echten Belohnungen zu verbinden, reibungslos und zuverlässig.',
      it: 'Creare un gioco di carte collezionabili su mobile che non si fermi allo schermo: le carte più belle devono sbloccare vere esperienze (weekend, festival, feste). La sfida — legare un gameplay coinvolgente a ricompense reali, in modo fluido e affidabile.',
      pt: 'Criar um jogo de cartas colecionáveis para mobile que não fique no ecrã: as melhores cartas devem desbloquear experiências reais (fins de semana, festivais, festas). O desafio — ligar uma jogabilidade viciante a recompensas reais, de forma fluida e fiável.',
      nl: 'Een mobiel verzamelkaartspel maken dat niet stopt bij het scherm: de mooiste kaarten moeten echte ervaringen ontgrendelen (weekends, festivals, feesten). De uitdaging — verslavende gameplay koppelen aan echte beloningen, soepel en betrouwbaar.',
      ar: 'ابتكار لعبة بطاقات قابلة للتجميع على الجوال لا تتوقف عند الشاشة: يجب أن تفتح أجمل البطاقات تجارب حقيقية (عطلات نهاية الأسبوع، مهرجانات، حفلات). التحدي — ربط أسلوب لعب مشوّق بمكافآت واقعية، بسلاسة وموثوقية.',
      pl: 'Stworzenie mobilnej kolekcjonerskiej gry karcianej, która nie kończy się na ekranie: najlepsze karty muszą odblokowywać prawdziwe doświadczenia (weekendy, festiwale, imprezy). Wyzwanie — połączyć wciągającą rozgrywkę z realnymi nagrodami, płynnie i niezawodnie.',
      tr: 'Ekranda son bulmayan bir mobil koleksiyon kart oyunu yaratmak: en güzel kartlar gerçek deneyimlerin kilidini açmalı (hafta sonları, festivaller, partiler). Zorluk — bağımlılık yapan bir oynanışı gerçek ödüllerle akıcı ve güvenilir biçimde birleştirmek.',
    },
    approach: {
      fr: 'Une app React Native / Expo pensée pour la collection et l’engagement, avec un back-end qui gère cartes, raretés et déblocage d’expériences IRL. Livrée sur iOS et Android.',
      en: 'A React Native / Expo app designed for collecting and engagement, with a back-end that manages cards, rarities and the unlocking of IRL experiences. Shipped on iOS and Android.',
      es: 'Una app React Native / Expo pensada para la colección y el engagement, con un back-end que gestiona cartas, rarezas y el desbloqueo de experiencias IRL. Publicada en iOS y Android.',
      de: 'Eine React Native / Expo App, konzipiert für Sammeln und Engagement, mit einem Back-end, das Karten, Seltenheiten und das Freischalten von IRL-Erlebnissen verwaltet. Veröffentlicht für iOS und Android.',
      it: "Un'app React Native / Expo pensata per la collezione e l'engagement, con un back-end che gestisce carte, rarità e sblocco di esperienze IRL. Rilasciata su iOS e Android.",
      pt: 'Uma app React Native / Expo pensada para a coleção e o engagement, com um back-end que gere cartas, raridades e o desbloqueio de experiências IRL. Lançada em iOS e Android.',
      nl: 'Een React Native / Expo-app ontworpen voor verzamelen en betrokkenheid, met een back-end die kaarten, zeldzaamheden en het ontgrendelen van IRL-ervaringen beheert. Uitgebracht op iOS en Android.',
      ar: 'تطبيق React Native / Expo مصمَّم للتجميع والتفاعل، مع واجهة خلفية تدير البطاقات والندرة وفتح التجارب الواقعية (IRL). صدر على iOS وAndroid.',
      pl: 'Aplikacja React Native / Expo zaprojektowana z myślą o kolekcjonowaniu i zaangażowaniu, z backendem zarządzającym kartami, rzadkością i odblokowywaniem doświadczeń IRL. Wydana na iOS i Android.',
      tr: 'Koleksiyon ve etkileşim için tasarlanmış bir React Native / Expo uygulaması; kartları, nadirlikleri ve IRL deneyimlerinin kilidini açmayı yöneten bir arka uçla birlikte. iOS ve Android üzerinde yayınlandı.',
    },
    stack: ['React Native', 'Expo', 'NestJS', 'PostgreSQL'],
    results: [
      { fr: '+250K téléchargements', en: '250K+ downloads', es: '+250K descargas', de: '+250K Downloads', it: '+250K download', pt: '+250K transferências', nl: '+250K downloads', ar: '+250 ألف تنزيل', pl: '+250 tys. pobrań', tr: '+250K indirme' },
      { fr: '4,8/5 de note moyenne', en: '4.8/5 average rating', es: '4,8/5 de valoración media', de: '4,8/5 Durchschnittsbewertung', it: '4,8/5 di voto medio', pt: '4,8/5 de avaliação média', nl: '4,8/5 gemiddelde beoordeling', ar: '4.8/5 متوسط التقييم', pl: '4,8/5 średniej oceny', tr: 'Ortalama 4,8/5 puan' },
      { fr: '12+ events IRL par an', en: '12+ IRL events per year', es: '12+ eventos IRL al año', de: '12+ IRL-Events pro Jahr', it: '12+ eventi IRL all’anno', pt: '12+ eventos IRL por ano', nl: '12+ IRL-events per jaar', ar: '+12 فعالية واقعية سنويًا', pl: '12+ wydarzeń IRL rocznie', tr: 'Yılda 12+ IRL etkinlik' },
    ],
  },
  {
    slug: 'labyrinth',
