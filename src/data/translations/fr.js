export default {
  ...
  'component.services_card.services.full_app': "Développement complet de l'application",
  ...
  'menu.services.full_app': "Développement complet de l'application",
  ...
  'page.about.since.title': "Construire une application complète et de meilleure qualité avec l'agence Khufu",
  ...
  'page.contact.form.lastname': 'Nom de famille',
  ...
  'page.home.summary.title': "CONSTRUISEZ UNE APPLICATION MEILLEURE ET COMPLÈTE AVEC L'AGENCE KHUFU",
  'page.services.dedicated.header.subtitle': 'Services',
  'page.services.dedicated.header.title': 'Ressources dédiées',
  'page.services.dedicated.offers.cto': 'DIRECTEUR TECHNIQUE',
  ...
  'page.services.dedicated.offers.qa': 'Testeur AQ',
  ...
  'page.services.dedicated.services.2.title': 'Ressources supplémentaires',
  'page.services.dedicated.services.3.content': "Un audit de performance et de maintenabilité sur l'infrastructure, le front-end et le back-end de votre produit.",
  ...
  'page.services.devops.offers.dashboard': 'Tableau de bord des performances',
  ...
  'page.services.devops.services.2.title': 'Tableau de bord des performances',
  'page.services.devops.services.3.content': 'Nous mettons en place des sauvegardes régulières et automatisées de votre infrastructure pour faire face aux incidents majeurs.',
  'page.services.devops.services.3.title': 'Sauvegardes automatisées',
  ...
  'page.services.full_app.footer.action': '"Estimation des cotes"',
  ...
  'page.services.full_app.header.title': "Développement complet de l'application",
  ...
  'page.services.full_app.offers.2.title': 'Création de produits (v1)',
  'page.services.full_app.offers.3.action': 'Nous contacter',
  'page.services.full_app.offers.3.title': 'Révision (v2)',
  ...
  'page.services.full_app.services.5.content': "Nous mettons en place l'infrastructure la plus robuste, la plus sûre et la plus adaptée à votre produit.",
